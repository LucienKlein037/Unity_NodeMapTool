...
public static class UnityExtensionMethod 
{
    ...
    //将屏幕坐标转换为 RectTransform 的本地坐标。适用于 UI 元素的点击检测。(不是很清楚作用和效果)
    //public static Vector2 ScreenToLocal(this RectTransform rect, Vector2 screenPoint)
    //{
    //    RectTransformUtility.ScreenPointToLocalPointInRectangle(rect, screenPoint, Camera.main, out Vector2 localPoint);
    //    return localPoint;
    //}
    //public static Vector3 ScreenToWorld(this RectTransform rect, Vector2 screenPoint)
    //{
    //    RectTransformUtility.ScreenPointToWorldPointInRectangle(rect, screenPoint, Camera.main, out Vector3 pos);
    //    return pos;
    //}
    //public static void ToMousePos(this RectTransform rectTransform)
    //{
